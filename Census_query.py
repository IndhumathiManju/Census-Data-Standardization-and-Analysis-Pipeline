...
def window_1():
    query ="SELECT District_Code, state_UT, District, Population FROM test.Census_df"
    df = window_1('Total population of each District', query)              
...
def window_3():
    ...
    df = window_3('Percentage of Workers in each district',query)    


    create_bar_chart(
        df,
        'Percentage_of_Workers', 
        'District', 
